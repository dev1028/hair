...
<hr>
	...
	<div class="col-5">
    	...
    	<option value="m1" <c:if test="${qnaModify.qna_category=='m1'}">selected="selected"</c:if>>예약 관련 문의</option>
	...
	<div class="col-auto">
		...
		<input type="text" class="form-control" id="qna_title" name="qna_title" value="${qnaModify.qna_title}">
  		<br>
	</div>
	<div class="col-auto">
		<label for="contents">내용</label>
  		<textarea class="form-control" id="qna_contents" name="qna_contents" rows="3" cols="30">${qnaModify.qna_contents}</textarea>
  		<br>
  	</div>
  	<div>
  		...
  		<option value="">선택</option>
    	<option value="1" <c:if test="${qnaModify.qna_openstatus=='1'}">selected="selected"</c:if>>공개</option>
    	<option value="0" <c:if test="${qnaModify.qna_openstatus=='0'}">selected="selected"</c:if>>비공개</option>
    	</select>
	</div>
	<br>
  	<div>

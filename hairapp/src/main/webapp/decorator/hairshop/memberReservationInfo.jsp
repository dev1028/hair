...
<script>
	$(function() {
		...
		$("#aBigPageMove").on("click" ,function(){
			opener.document.location.href="${pageContext.request.contextPath}/hairshop/hsFindMyCustomerDetail.do?mdr_no=${mdrResult.mdr_no}";
			self.close();
		});
				...
				<div class="card-body">
					<c:forEach items="${detailInfo}" var="info">
						<div class="card text-center " style="width: 18rem;">
							<div class="card-body">
								<h5 class="card-title" data-hhiNo="${info.hhi_no}" data-link="${pageContext.request.contextPath}/hairshop/hairInfoDetail.do?hhi_no=${info.hhi_no}"><a href="#">${info.hhi_name}</a></h5>

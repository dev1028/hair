...
<script>
	function qnaModifyGo() {
		location.href = "hairshopQnaMG.do";
}
	
	function qnaDeleteGo() {
		location.href = "hairshopQnaD.do";
}
	
	function qnaGo() {
		location.href = "hairshopQna.do";
}
	
	function qnaRe() {
		location.href = "hairshopQnaReG.do?num=${view.qna_no}&page=${pageNum}";
}
...
<thead>
  ...
  <tr>
  	<th>문의유형</th>
  	<c:if test="${view.qna_category == 'a1'}">
  	<td>입점문의</td>
  	</c:if>

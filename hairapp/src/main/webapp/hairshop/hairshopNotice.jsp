...
<form method="post" name="frm2" id="frm2" action="hairshopNoticeView.do">
...
<%--   <input type="hidden" name="noticeHit" value="${board.notice_hits}"> --%>
  <tr>
  	...
  	<td><a href="hairshopNoticeView.do?notice_no=${board.notice_no}&notice_hit=${board.notice_hits}">${board.notice_title}</a></td>
  	<td>관리자</td>

				...
				<form class="needs-validation" id="hairinfoInsertFrm"
					...
					<div class="mb-3">
						<div class="input-group">
							...
							<textarea name="hs_profile" rows="10" class="form-control" aria-label="With textarea">${hairshop.hs_profile}</textarea>
						...
						<hr class="mb-4">
							...
							<div class="input-group">
								...
								<textarea name="hs_notice" rows="10" class="form-control" aria-label="With textarea">${hairshop.hs_notice}</textarea>
